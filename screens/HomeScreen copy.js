...
import { Text, FlatList, Image,StyleSheet,Dimensions,View,Vibration,ScrollView,TouchableOpacity} from 'react-native';
    ...
    return (
      ...
      <View>
          ...
          >
            ...
            containerStyle={{ backgroundColor: 'transparent',width:'100%', borderBottomColor: 'transparent', borderTopColor: 'transparent'}} 
            inputContainerStyle={{ backgroundColor: '#EDEDED', width:'100%' }}
            inputStyle={{ backgroundColor: '#EDEDED',borderRadius: 10,color: 'black',width:'100%' }}
            searchIcond
            clearIcon
            lightTheme
            round
